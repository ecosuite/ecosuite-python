...
from ...models.forecast_generation_datums_aggregation import ForecastGenerationDatumsAggregation
...
def _get_kwargs(
    *,
    ...
    aggregation: Union[Unset, ForecastGenerationDatumsAggregation] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/energy/datums/generation/forecast",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        aggregation (Union[Unset, ForecastGenerationDatumsAggregation]):
