...
from ...models.forecast_consumption_datums_aggregation import ForecastConsumptionDatumsAggregation
...
def _get_kwargs(
    *,
    ...
    aggregation: Union[Unset, ForecastConsumptionDatumsAggregation] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/energy/datums/consumption/forecast",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        aggregation (Union[Unset, ForecastConsumptionDatumsAggregation]):
