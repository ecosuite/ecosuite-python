...
from ...models.project_forecast_generation_datums_aggregation import ProjectForecastGenerationDatumsAggregation
...
def _get_kwargs(
    ...
    *,
    ...
    aggregation: Union[Unset, ProjectForecastGenerationDatumsAggregation] = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/energy/datums/generation/forecast/projects/{project_id}",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        aggregation (Union[Unset, ProjectForecastGenerationDatumsAggregation]):
