...
T = TypeVar("T", bound="TariffEnergyWeekEndSchedule")


@_attrs_define
class TariffEnergyWeekEndSchedule:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        tariff_energy_week_end_schedule = cls(
            april=april,
            august=august,
            december=december,
            february=february,
        ...
        tariff_energy_week_end_schedule.additional_properties = d
        return tariff_energy_week_end_schedule
