...
T = TypeVar("T", bound="UpdateProjectRecordResponse200")


@_attrs_define
class UpdateProjectRecordResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_project_record_response_200 = cls(
            record=record,
        )

        update_project_record_response_200.additional_properties = d
        return update_project_record_response_200
