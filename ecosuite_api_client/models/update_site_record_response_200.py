...
T = TypeVar("T", bound="UpdateSiteRecordResponse200")


@_attrs_define
class UpdateSiteRecordResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_site_record_response_200 = cls(
            record=record,
        )

        update_site_record_response_200.additional_properties = d
        return update_site_record_response_200
