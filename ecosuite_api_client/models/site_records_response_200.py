...
T = TypeVar("T", bound="SiteRecordsResponse200")


@_attrs_define
class SiteRecordsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        site_records_response_200 = cls(
            records=records,
        )

        site_records_response_200.additional_properties = d
        return site_records_response_200
