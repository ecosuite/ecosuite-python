...
T = TypeVar("T", bound="CreateSiteRecordResponse200")


@_attrs_define
class CreateSiteRecordResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_site_record_response_200 = cls(
            record=record,
        )

        create_site_record_response_200.additional_properties = d
        return create_site_record_response_200
