...
T = TypeVar("T", bound="CreateProjectRecordResponse200")


@_attrs_define
class CreateProjectRecordResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_project_record_response_200 = cls(
            record=record,
        )

        create_project_record_response_200.additional_properties = d
        return create_project_record_response_200
