...
T = TypeVar("T", bound="UpdateSystemRecordResponse200")


@_attrs_define
class UpdateSystemRecordResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_system_record_response_200 = cls(
            record=record,
        )

        update_system_record_response_200.additional_properties = d
        return update_system_record_response_200
