...
T = TypeVar("T", bound="ProjectRecordsResponse200")


@_attrs_define
class ProjectRecordsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        project_records_response_200 = cls(
            records=records,
        )

        project_records_response_200.additional_properties = d
        return project_records_response_200
