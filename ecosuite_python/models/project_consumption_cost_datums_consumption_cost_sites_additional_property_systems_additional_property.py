...
T = TypeVar("T", bound="ProjectConsumptionCostDatumsConsumptionCostSitesAdditionalPropertySystemsAdditionalProperty")


@_attrs_define
class ProjectConsumptionCostDatumsConsumptionCostSitesAdditionalPropertySystemsAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_consumption_cost_datums_consumption_cost_sites_additional_property_systems_additional_property = cls(
        ...
        project_consumption_cost_datums_consumption_cost_sites_additional_property_systems_additional_property.additional_properties = d
        return project_consumption_cost_datums_consumption_cost_sites_additional_property_systems_additional_property
