...
from ..models.project_datums_response_200_aggregation import ProjectDatumsResponse200Aggregation
...
T = TypeVar("T", bound="ProjectDatumsResponse200")


@_attrs_define
class ProjectDatumsResponse200:
    """
    Attributes:
        project_datums (Union[Unset, ProjectDatums]):
        range_ (Union[Unset, Range]):
        aggregation (Union[Unset, ProjectDatumsResponse200Aggregation]):
    """

    project_datums: Union[Unset, "ProjectDatums"] = UNSET
    range_: Union[Unset, "Range"] = UNSET
    aggregation: Union[Unset, ProjectDatumsResponse200Aggregation] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_project_datums, Unset):
            ...
            project_datums = ProjectDatums.from_dict(_project_datums)
        ...
        if isinstance(_aggregation, Unset):
            ...
            aggregation = ProjectDatumsResponse200Aggregation(_aggregation)

        project_datums_response_200 = cls(
            project_datums=project_datums,
            range_=range_,
            aggregation=aggregation,
        )

        project_datums_response_200.additional_properties = d
        return project_datums_response_200
