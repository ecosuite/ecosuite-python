...
T = TypeVar("T", bound="ParameterStoreNameResponse")


@_attrs_define
class ParameterStoreNameResponse:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        parameter_store_name_response = cls(
            name=name,
            value=value,
            last_modified_date=last_modified_date,
        )

        parameter_store_name_response.additional_properties = d
        return parameter_store_name_response
