...
T = TypeVar("T", bound="SaveProjectProFormaResponse200")


@_attrs_define
class SaveProjectProFormaResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        save_project_pro_forma_response_200 = cls(
            pro_forma=pro_forma,
        )

        save_project_pro_forma_response_200.additional_properties = d
        return save_project_pro_forma_response_200
