...
T = TypeVar("T", bound="UpdateProfileResponse200")


@_attrs_define
class UpdateProfileResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_profile_response_200 = cls(
            profile=profile,
        )

        update_profile_response_200.additional_properties = d
        return update_profile_response_200
