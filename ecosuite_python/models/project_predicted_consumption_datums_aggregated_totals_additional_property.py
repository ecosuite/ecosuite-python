...
T = TypeVar("T", bound="ProjectPredictedConsumptionDatumsAggregatedTotalsAdditionalProperty")


@_attrs_define
class ProjectPredictedConsumptionDatumsAggregatedTotalsAdditionalProperty:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_predicted_consumption_datums_aggregated_totals_additional_property = cls(
            predicted_consumption=predicted_consumption,
            historic_consumption=historic_consumption,
            target_consumption=target_consumption,
        )

        project_predicted_consumption_datums_aggregated_totals_additional_property.additional_properties = d
        return project_predicted_consumption_datums_aggregated_totals_additional_property
