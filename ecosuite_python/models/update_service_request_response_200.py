...
T = TypeVar("T", bound="UpdateServiceRequestResponse200")


@_attrs_define
class UpdateServiceRequestResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_service_request_response_200 = cls(
            service_request=service_request,
        )

        update_service_request_response_200.additional_properties = d
        return update_service_request_response_200
