...
T = TypeVar("T", bound="UpdateUserNotificationResponse200")


@_attrs_define
class UpdateUserNotificationResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_user_notification_response_200 = cls(
            notification=notification,
        )

        update_user_notification_response_200.additional_properties = d
        return update_user_notification_response_200
