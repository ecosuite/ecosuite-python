...
T = TypeVar("T", bound="ProjectsResponse200")


@_attrs_define
class ProjectsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        projects_response_200 = cls(
            projects=projects,
        )

        projects_response_200.additional_properties = d
        return projects_response_200
