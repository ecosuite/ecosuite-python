...
T = TypeVar("T", bound="CreatePortfolioResponse200")


@_attrs_define
class CreatePortfolioResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        create_portfolio_response_200 = cls(
            portfolio=portfolio,
        )

        create_portfolio_response_200.additional_properties = d
        return create_portfolio_response_200
