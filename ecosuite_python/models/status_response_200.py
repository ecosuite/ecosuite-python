...
T = TypeVar("T", bound="StatusResponse200")


@_attrs_define
class StatusResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        status_response_200 = cls(
            projects=projects,
        )

        status_response_200.additional_properties = d
        return status_response_200
