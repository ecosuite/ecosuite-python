...
T = TypeVar("T", bound="GetTagFilesResponse200")


@_attrs_define
class GetTagFilesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        get_tag_files_response_200 = cls(
            media=media,
        )

        get_tag_files_response_200.additional_properties = d
        return get_tag_files_response_200
