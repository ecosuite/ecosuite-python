...
T = TypeVar("T", bound="PortfolioResponse200")


@_attrs_define
class PortfolioResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        portfolio_response_200 = cls(
            portfolio=portfolio,
        )

        portfolio_response_200.additional_properties = d
        return portfolio_response_200
