...
T = TypeVar("T", bound="UpdateSiteResponse200")


@_attrs_define
class UpdateSiteResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_site_response_200 = cls(
            site=site,
        )

        update_site_response_200.additional_properties = d
        return update_site_response_200
