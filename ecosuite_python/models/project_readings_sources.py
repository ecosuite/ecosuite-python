...
T = TypeVar("T", bound="ProjectReadingsSources")


@_attrs_define
class ProjectReadingsSources:
    """Keyed by Source ID"""
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        project_readings_sources.additional_properties = additional_properties
        return project_readings_sources
