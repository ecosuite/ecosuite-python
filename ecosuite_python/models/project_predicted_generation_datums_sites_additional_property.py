...
if TYPE_CHECKING:
    from ..models.project_predicted_generation_datums_sites_additional_property_aggregated_totals import (
        ProjectPredictedGenerationDatumsSitesAdditionalPropertyAggregatedTotals,
    )
    from ..models.project_predicted_generation_datums_sites_additional_property_systems import (
        ProjectPredictedGenerationDatumsSitesAdditionalPropertySystems,
    )


T = TypeVar("T", bound="ProjectPredictedGenerationDatumsSitesAdditionalProperty")


@_attrs_define
class ProjectPredictedGenerationDatumsSitesAdditionalProperty:
    """
    Attributes:
        ...
        aggregated_totals (Union[Unset, ProjectPredictedGenerationDatumsSitesAdditionalPropertyAggregatedTotals]): Keyed
            by datum date
        systems (Union[Unset, ProjectPredictedGenerationDatumsSitesAdditionalPropertySystems]): Keyed by System ID
    """
    ...
    aggregated_totals: Union[Unset, "ProjectPredictedGenerationDatumsSitesAdditionalPropertyAggregatedTotals"] = UNSET
    systems: Union[Unset, "ProjectPredictedGenerationDatumsSitesAdditionalPropertySystems"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        aggregated_totals: Union[Unset, ProjectPredictedGenerationDatumsSitesAdditionalPropertyAggregatedTotals]
        if isinstance(_aggregated_totals, Unset):
            aggregated_totals = UNSET
        else:
            aggregated_totals = ProjectPredictedGenerationDatumsSitesAdditionalPropertyAggregatedTotals.from_dict(
                _aggregated_totals
            )

        _systems = d.pop("systems", UNSET)
        systems: Union[Unset, ProjectPredictedGenerationDatumsSitesAdditionalPropertySystems]
        if isinstance(_systems, Unset):
            systems = UNSET
        else:
            systems = ProjectPredictedGenerationDatumsSitesAdditionalPropertySystems.from_dict(_systems)

        project_predicted_generation_datums_sites_additional_property = cls(
        ...
        project_predicted_generation_datums_sites_additional_property.additional_properties = d
        return project_predicted_generation_datums_sites_additional_property
