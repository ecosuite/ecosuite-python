...
if TYPE_CHECKING:
    from ..models.rfi_stored_schema_resolution_history import RFIStoredSchemaResolutionHistory


T = TypeVar("T", bound="RFIStoredSchema")


@_attrs_define
class RFIStoredSchema:
    """
    Attributes:
        id (str): The RFI ID.
        ...
        resolution_history (RFIStoredSchemaResolutionHistory): The RFI resolution history.
    ...
    version: str
    resolved: bool
    resolution_history: "RFIStoredSchemaResolutionHistory"
    code: str
    name: str
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        resolution_history = RFIStoredSchemaResolutionHistory.from_dict(d.pop("resolutionHistory"))
        ...
        rfi_stored_schema.additional_properties = d
        return rfi_stored_schema
