...
if TYPE_CHECKING:
    from ..models.project_readings_sites_additional_property_sources import (
        ProjectReadingsSitesAdditionalPropertySources,
    )
    from ..models.project_readings_sites_additional_property_systems import (
        ProjectReadingsSitesAdditionalPropertySystems,
    )


T = TypeVar("T", bound="ProjectReadingsSitesAdditionalProperty")


@_attrs_define
class ProjectReadingsSitesAdditionalProperty:
    """
    Attributes:
        ...
        sources (Union[Unset, ProjectReadingsSitesAdditionalPropertySources]): Keyed by Source ID
        systems (Union[Unset, ProjectReadingsSitesAdditionalPropertySystems]): Keyed by System ID
    """
    ...
    sources: Union[Unset, "ProjectReadingsSitesAdditionalPropertySources"] = UNSET
    systems: Union[Unset, "ProjectReadingsSitesAdditionalPropertySystems"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sources: Union[Unset, ProjectReadingsSitesAdditionalPropertySources]
        if isinstance(_sources, Unset):
            sources = UNSET
        else:
            sources = ProjectReadingsSitesAdditionalPropertySources.from_dict(_sources)

        _systems = d.pop("systems", UNSET)
        systems: Union[Unset, ProjectReadingsSitesAdditionalPropertySystems]
        if isinstance(_systems, Unset):
            systems = UNSET
        else:
            systems = ProjectReadingsSitesAdditionalPropertySystems.from_dict(_systems)

        project_readings_sites_additional_property = cls(
        ...
        project_readings_sites_additional_property.additional_properties = d
        return project_readings_sites_additional_property
