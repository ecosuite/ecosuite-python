...
T = TypeVar("T", bound="UpdateTagResponse200")


@_attrs_define
class UpdateTagResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_tag_response_200 = cls(
            tag=tag,
        )

        update_tag_response_200.additional_properties = d
        return update_tag_response_200
