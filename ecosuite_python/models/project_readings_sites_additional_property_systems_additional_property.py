...
if TYPE_CHECKING:
    from ..models.project_readings_sites_additional_property_systems_additional_property_sources import (
        ProjectReadingsSitesAdditionalPropertySystemsAdditionalPropertySources,
    )


T = TypeVar("T", bound="ProjectReadingsSitesAdditionalPropertySystemsAdditionalProperty")


@_attrs_define
class ProjectReadingsSitesAdditionalPropertySystemsAdditionalProperty:
    """
    Attributes:
        ...
        sources (Union[Unset, ProjectReadingsSitesAdditionalPropertySystemsAdditionalPropertySources]): Keyed by Source
            ID
    """
    ...
    sources: Union[Unset, "ProjectReadingsSitesAdditionalPropertySystemsAdditionalPropertySources"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        sources: Union[Unset, ProjectReadingsSitesAdditionalPropertySystemsAdditionalPropertySources]
        if isinstance(_sources, Unset):
            sources = UNSET
        else:
            sources = ProjectReadingsSitesAdditionalPropertySystemsAdditionalPropertySources.from_dict(_sources)

        project_readings_sites_additional_property_systems_additional_property = cls(
        ...
        project_readings_sites_additional_property_systems_additional_property.additional_properties = d
        return project_readings_sites_additional_property_systems_additional_property
