...
T = TypeVar("T", bound="UpdateFileResponse200")


@_attrs_define
class UpdateFileResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        update_file_response_200 = cls(
            media=media,
        )

        update_file_response_200.additional_properties = d
        return update_file_response_200
